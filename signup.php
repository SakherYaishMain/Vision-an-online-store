  ...
  <body>
    <?php
      if (isset($_REQUEST['error'])) {
        if($_REQUEST['error'] == 'passwordsdontmatch'){
      ...
      <div class="left-form">
        ...
        <div class="form-content">
          <form class="" action="./config/config.php" method="post">
            ...
            <input type="text" name="fullname" placeholder="Enter your full name" required autocomplete="none"><br><br>
            ...
            <input type="password" name="password2" placeholder="" required autocomplete="none"><br><br>
